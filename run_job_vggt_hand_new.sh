...
#SBATCH --output=/work/courses/3dv/team22/RGBTrack/logs/job_vggt_hand_new_%j.out
#SBATCH --error=/work/courses/3dv/team22/RGBTrack/logs/job_vggt_hand_new_%j.err
...
/work/courses/3dv/team22/py310_env/bin/python run_demo_vggt_hand.py \
    ...
    --debug_dir /work/courses/3dv/team22/foundationpose/debug/duck_vggt_hand_new \
    --est_refine_iter 2 \
    --track_refine_iter 2 \
    --debug 2 \
