...
#SBATCH --output=/work/courses/3dv/team22/RGBTrack/logs/job_vda_cad_%j.out
#SBATCH --error=/work/courses/3dv/team22/RGBTrack/logs/job_vda_cad_%j.err
...
/work/courses/3dv/team22/py310_env/bin/python run_demo_vda_hand.py \
    ...
    --masks_dir      /work/courses/3dv/team22/foundationpose/data/20250804_104715/masks_cad_anchored \
    --debug_dir      /work/courses/3dv/team22/foundationpose/debug/duck_vda_cad \
    --est_refine_iter 2 \
    --track_refine_iter 2 \
    --debug 2
