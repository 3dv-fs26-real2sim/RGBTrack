...
#SBATCH --output=/work/courses/3dv/team22/RGBTrack/logs/job_tightly_coupled_%j.out
#SBATCH --error=/work/courses/3dv/team22/RGBTrack/logs/job_tightly_coupled_%j.err
