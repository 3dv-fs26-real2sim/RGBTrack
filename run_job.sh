#!/bin/bash
#SBATCH --account=3dv                        # course/project account tag — change if needed
#SBATCH --time=06:00:00
#SBATCH --output=/work/courses/3dv/team22/RGBTrack/logs/job_%j.out
#SBATCH --error=/work/courses/3dv/team22/RGBTrack/logs/job_%j.err

# ── Init module system (required in batch jobs) ────────────────────────────────
