...
#SBATCH --output=/work/courses/3dv/team22/RGBTrack/logs/job_tc_%j.out
#SBATCH --error=/work/courses/3dv/team22/RGBTrack/logs/job_tc_%j.err
...
/work/courses/3dv/team22/py310_env/bin/python run_demo_tightly_coupled.py \
    ...
    --debug_dir      /work/courses/3dv/team22/foundationpose/debug/duck_tc_nobg \
    --est_refine_iter 2 \
    --track_refine_iter 2 \
    --debug 2
