...
#SBATCH --output=/work/courses/3dv/team22/RGBTrack/logs/job_fp_freeze_regular_%j.out
#SBATCH --error=/work/courses/3dv/team22/RGBTrack/logs/job_fp_freeze_regular_%j.err

# FP++ with anomaly detection + freeze rotation, on the regular scene
# (data lives in team22/foundationpose/data, output in team22 debug dir).
# Usage: sbatch run_job_fp_freeze_regular.sh [SCENE_NAME]
SCENE=${1:-20250804_104715}
SCENE_DIR=/work/courses/3dv/team22/foundationpose/data/$SCENE
OUT_DIR=/work/courses/3dv/team22/foundationpose/debug/duck_fp_freeze_$SCENE
