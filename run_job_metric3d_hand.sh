...
#SBATCH --output=/work/courses/3dv/team22/RGBTrack/logs/job_metric3d_hand_%j.out
#SBATCH --error=/work/courses/3dv/team22/RGBTrack/logs/job_metric3d_hand_%j.err
...
/work/courses/3dv/team22/py310_env/bin/python run_demo_vda_hand.py \
    ...
    --debug_dir /work/courses/3dv/team22/foundationpose/debug/duck_metric3d_hand \
    --est_refine_iter 2 \
    --track_refine_iter 2 \
    --debug 2 \
