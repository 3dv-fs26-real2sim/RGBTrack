...
#SBATCH --output=/work/courses/3dv/team22/RGBTrack/logs/job_metric3d_%j.out
#SBATCH --error=/work/courses/3dv/team22/RGBTrack/logs/job_metric3d_%j.err
...
/work/courses/3dv/team22/py310_env/bin/python run_demo_with_depth.py \
    ...
    --debug_dir /work/courses/3dv/team22/foundationpose/debug/duck_metric3d \
    --est_refine_iter 2 \
    --track_refine_iter 2 \
    --debug 2 \
