...
# Original (Apr 14, f811b0f) used /work/courses/3dv/team22/scaled_with_desk/depth_png
# (a colleague-scaled depth set). That dir was cleaned, so we use depth_pro
# directly — Depth Pro is already metric so no extra scaling required.
...
/work/courses/3dv/team22/py310_env/bin/python run_demo_bsd_raw_depth.py \
    ...
    --pred_depth_dir /work/courses/3dv/team22/foundationpose/data/20250804_104715/depth_pro \
