...
#SBATCH --output=/work/courses/3dv/team22/RGBTrack/logs/job_vis_depth_vda_%j.out
#SBATCH --error=/work/courses/3dv/team22/RGBTrack/logs/job_vis_depth_vda_%j.err
...
/work/courses/3dv/team22/py310_env/bin/python visualize_depth.py \
    ...
    --calibrate \
    --fps            50 \
    --out_video      /work/courses/3dv/team22/foundationpose/debug/depth_vda.mp4
