...
#SBATCH --output=/work/courses/3dv/team22/RGBTrack/logs/job_sam2_guided_%j.out
#SBATCH --error=/work/courses/3dv/team22/RGBTrack/logs/job_sam2_guided_%j.err
...
/work/courses/3dv/team22/py310_env/bin/python run_sam2_cad_guided.py \
    ...
    --mask_out_dir   /work/courses/3dv/team22/foundationpose/data/20250804_104715/masks_cad_guided \
    --anchor_interval 5
