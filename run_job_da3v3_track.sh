...
#SBATCH --output=/work/courses/3dv/team22/RGBTrack/logs/job_da3v3_track_%j.out
#SBATCH --error=/work/courses/3dv/team22/RGBTrack/logs/job_da3v3_track_%j.err
...
/work/courses/3dv/team22/py310_env/bin/python run_demo_vda_depth.py \
    ...
    --pred_depth_dir /work/courses/3dv/team22/foundationpose/data/20250804_104715/depth_da3v3 \
    --sim_depth      /work/courses/3dv/team22/table_depth_masked.npz \
    --debug_dir      /work/courses/3dv/team22/foundationpose/debug/duck_da3v3 \
    --est_refine_iter 2 \
    --track_refine_iter 2 \
    --debug 2
