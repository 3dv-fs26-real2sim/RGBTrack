...
#SBATCH --output=/work/courses/3dv/team22/RGBTrack/logs/job_fp_bg11_%j.out
#SBATCH --error=/work/courses/3dv/team22/RGBTrack/logs/job_fp_bg11_%j.err
...
/work/courses/3dv/team22/py310_env/bin/python run_demo_tightly_coupled.py \
    ...
    --masks_dir      /work/courses/3dv/team22/foundationpose/data/20250804_104715/masks \
    --debug_dir      /work/courses/3dv/team22/foundationpose/debug/duck_fp_bg11 \
    --est_refine_iter 2 \
    --track_refine_iter 2 \
    --debug 2
