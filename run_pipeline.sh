...
# ── 5. FoundationPose tracking — run_demo_vda_hand (gold-standard recipe that
#       produced duck_vda_palm_rot). Internal BSD-anchored depth scaling at
#       frame 0, ScoreNet off, centroid translation correction, occlusion-aware
#       recovery. No external scaling substep needed.
if ! run_step 5; then
