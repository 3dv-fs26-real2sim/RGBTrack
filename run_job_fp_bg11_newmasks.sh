...
#SBATCH --output=/work/courses/3dv/team22/RGBTrack/logs/job_fp_bg11_newmasks_%j.out
#SBATCH --error=/work/courses/3dv/team22/RGBTrack/logs/job_fp_bg11_newmasks_%j.err
